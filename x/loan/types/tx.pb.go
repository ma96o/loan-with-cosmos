...
func init() {
	proto.RegisterType((*MsgRequestLoan)(nil), "loanwithcosmos.loan.MsgRequestLoan")
	proto.RegisterType((*MsgRequestLoanResponse)(nil), "loanwithcosmos.loan.MsgRequestLoanResponse")
	proto.RegisterType((*MsgApproveLoan)(nil), "loanwithcosmos.loan.MsgApproveLoan")
	proto.RegisterType((*MsgApproveLoanResponse)(nil), "loanwithcosmos.loan.MsgApproveLoanResponse")
	proto.RegisterType((*MsgRepayLoan)(nil), "loanwithcosmos.loan.MsgRepayLoan")
	proto.RegisterType((*MsgRepayLoanResponse)(nil), "loanwithcosmos.loan.MsgRepayLoanResponse")
	proto.RegisterType((*MsgLiquidateLoan)(nil), "loanwithcosmos.loan.MsgLiquidateLoan")
	proto.RegisterType((*MsgLiquidateLoanResponse)(nil), "loanwithcosmos.loan.MsgLiquidateLoanResponse")
	proto.RegisterType((*MsgCancelLoan)(nil), "loanwithcosmos.loan.MsgCancelLoan")
	proto.RegisterType((*MsgCancelLoanResponse)(nil), "loanwithcosmos.loan.MsgCancelLoanResponse")
}
...
var fileDescriptor_b8f8f93b4237d328 = []byte{
	...
	,
}
...
func (c *msgClient) RequestLoan(ctx context.Context, in *MsgRequestLoan, opts ...grpc.CallOption) (*MsgRequestLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loanwithcosmos.loan.Msg/RequestLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ApproveLoan(ctx context.Context, in *MsgApproveLoan, opts ...grpc.CallOption) (*MsgApproveLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loanwithcosmos.loan.Msg/ApproveLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RepayLoan(ctx context.Context, in *MsgRepayLoan, opts ...grpc.CallOption) (*MsgRepayLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loanwithcosmos.loan.Msg/RepayLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) LiquidateLoan(ctx context.Context, in *MsgLiquidateLoan, opts ...grpc.CallOption) (*MsgLiquidateLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loanwithcosmos.loan.Msg/LiquidateLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CancelLoan(ctx context.Context, in *MsgCancelLoan, opts ...grpc.CallOption) (*MsgCancelLoanResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/loanwithcosmos.loan.Msg/CancelLoan", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RequestLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loanwithcosmos.loan.Msg/RequestLoan",
	}
...
func _Msg_ApproveLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loanwithcosmos.loan.Msg/ApproveLoan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RepayLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loanwithcosmos.loan.Msg/RepayLoan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_LiquidateLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loanwithcosmos.loan.Msg/LiquidateLoan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CancelLoan_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/loanwithcosmos.loan.Msg/CancelLoan",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "loanwithcosmos.loan.Msg",
