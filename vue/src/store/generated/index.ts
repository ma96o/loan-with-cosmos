...
import LoanWithCosmosLoanwithcosmosLoan from './loan-with-cosmos/loanwithcosmos.loan'
...
export default { 
  ...
  LoanWithCosmosLoanwithcosmosLoan: load(LoanWithCosmosLoanwithcosmosLoan, 'loanwithcosmos.loan'),
